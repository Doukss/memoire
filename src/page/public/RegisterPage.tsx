...
function RegisterPage() {
  ...
  const AGENCY_PLAN = "Professionnel";
  const [step, setStep] = useState<"form" | "success">("form");
  const [selectedRole] = useState<UserRole>("agency");
          ...
          <div className="w-full max-w-md">
            ...
            <div>
              ...
              <p className="mt-3 text-sm leading-6 text-slate-600">
                Inscrivez votre agence immobilière et commencez à gérer vos biens dès maintenant.
                Plan {AGENCY_PLAN} avec 14 jours d'essai gratuit.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-5">
              <div>
                ...
                <input
                  ...
                  placeholder="Dakar Prestige Immobilier"
            ...
            {step === "success" && (
              <div className="text-center">
                ...
                <h2 className="text-3xl font-bold text-slate-950">Agence créée avec succès !</h2>
                <p className="mt-4 text-slate-600">
                  Votre agence a été créée avec le plan {AGENCY_PLAN}. Vous allez être redirigé vers votre espace.
                </p>
                <div className="mt-8">
                  <a
                    href="/agence"
